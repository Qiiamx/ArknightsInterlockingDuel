	...
	<div class="clash-layer" v-if="visible">
		<div class="clash-arena">
			<div
				...
				:class="[
					stageClass,
					{ winner: result === 'A', loser: result === 'B', draw: result === 'DRAW' },
				]"
			>
			...
			<div
				...
				:class="[
					stageClass,
					{ winner: result === 'B', loser: result === 'A', draw: result === 'DRAW' },
				]"
			>
...
const startAnimation = () => {
	// 1. 判定结果
	if (valA.value > valB.value) result.value = 'A';
	else if (valB.value > valA.value) result.value = 'B';
